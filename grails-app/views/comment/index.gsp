		...
		<div id="list-comment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="creationTime" title="${message(code: 'comment.creationTime.label', default: 'Creation Time')}" />
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${commentInstance.creationTime}" /></td>
