		...
		<div id="list-post" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="creationTime" title="${message(code: 'post.creationTime.label', default: 'Creation Time')}" />
				...
				<g:each in="${postInstanceList}" status="i" var="postInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${postInstance.creationTime}" /></td>
